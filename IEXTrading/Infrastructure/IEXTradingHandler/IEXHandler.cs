    ...
    public class IEXHandler
    {
        ...
        ****/
        ...
        public Stock GetStocks(string symbol)
        {
            ...
            //string IEXTrading_API_PATH2 = BASE_URL + "stock/" + symbol + "/stats";

            //string chart = "";
            //httpClient.BaseAddress = new Uri(IEXTrading_API_PATH2);
            //HttpResponseMessage response2 = httpClient.GetAsync(IEXTrading_API_PATH2).GetAwaiter().GetResult();
            //if (response2.IsSuccessStatusCode)
            //{
            //    chart = response2.Content.ReadAsStringAsync().GetAwaiter().GetResult();
            //}
            //if (!chart.Equals(""))
            //{
            //    Stocks = JsonConvert.DeserializeObject<List<Stock>>(chart);
            //}
            //return Stocks;
        }
